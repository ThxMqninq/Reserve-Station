...
Если проблема относится не к данной сборке, а к **Space Station 14** в целом - можно найти их репозиторий и проследовать соответсвующему процессу, указанному там.
