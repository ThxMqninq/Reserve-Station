...
namespace Content.Server._Reserve.Service;
...
public sealed partial class ServiceJobBoardSystem : EntitySystem
{
    ...
    private static readonly string AnnouncementName = "service-job-console-announcement-name";
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out var data))
        {
            ...
            {
                _chatSystem.DispatchStationAnnouncement(uid, Loc.GetString(job.StartAnnounce), Loc.GetString(AnnouncementName), colorOverride: AnnouncementColor);
