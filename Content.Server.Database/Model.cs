...
namespace Content.Server.Database
{
    public abstract class ServerDbContext : DbContext
    {
        ...
        public DbSet<DBJobAlternateTitle> DBJobAlternateTitle { get; set; } = null!;  // Reserve: Alternate Job Titles
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DBJobAlternateTitle>()  // Reserve: Alternate Job Titles
                .HasOne(e => e.Profile)
    ...
    public class Profile
    {
        ...
        // public string BarkVoice { get; set; } = null!; // Goob Station - Barks // Reserve - use other barks
        ...
        public List<DBJobAlternateTitle> AltTitles { get; } = new();  // Reserve: Alternate Job Titles
    ...
    public class DBJobAlternateTitle  // Reserve: Alternate Job Titles
    {
        public int Id { get; set; }
        public Profile Profile { get; set; } = null!;
        public int ProfileId { get; set; }
