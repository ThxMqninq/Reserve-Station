...
using System.Linq;
using Content.Client._Reserve.VendingMachines; // Reserve edit: Diegetic vending
...
public sealed class VendingMachineSystem : SharedVendingMachineSystem
{
    ...
    private void OnVendingHandleState(Entity<VendingMachineComponent> entity, ref ComponentHandleState args)
    {
        ...
        if (UISystem.TryGetOpenUi<BoundUserInterface>(uid, VendingMachineUiKey.Key, out var baseBui) && baseBui is IVendingMachineBoundUi bui) // Reserve edit: Diegetic vending
        {
            if (fullUiUpdate)
            {
                bui.Refresh();
    ...
    protected override void UpdateUI(Entity<VendingMachineComponent?> entity)
    {
        ...
        if (UISystem.TryGetOpenUi<BoundUserInterface>(entity.Owner,
                ...
                out var baseBui) && baseBui is IVendingMachineBoundUi bui) // Reserve edit: Diegetic vending
        {
            bui.UpdateAmounts();
        }
    }
