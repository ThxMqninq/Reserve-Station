...
game-ticker-get-info-text =
    Привет и добро пожаловать на [bold][color=#c23c2d]Резерв[/color][/bold]!
...
game-ticker-get-info-preround-text =
    ...
    Текущий режим игры: [color=white]{ $gmTitle }[/color]
    > [color=#a88b5e]{ $desc }[/color]
game-ticker-no-map-selected = [color=#8f0303]Карта ещё не выбрана![/color]
