...
ent-EncryptionKeyBinary = ключ двоичного перевода
    .desc = Ключ шифрования, используемый для преобразования двоичного кода, используемого синтетами.
ent-EncryptionKeyBinarySyndicate = ключ двоичного перевода
    .desc = Ключ шифрования Синдиката, используемый для преобразования двоичного кода, используемого синтетами.
