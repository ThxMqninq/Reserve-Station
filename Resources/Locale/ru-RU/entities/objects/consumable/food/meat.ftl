...
ent-FoodMeatPatty = сырая бургерная котлета
    .desc = Плоский кусок мяса. Готов к прожарке.
...
ent-FoodMeatPattyCooked = бургерная котлета
    .desc = Приготовленная бургерная котлета.
