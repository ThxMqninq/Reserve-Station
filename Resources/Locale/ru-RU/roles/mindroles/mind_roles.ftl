...
ent-MindRoleGhostRoleFreeAgentHarmless = Роль призрака (Свободный агент)
    .desc = { ent-MindRoleGhostRoleNeutral.desc }
ent-MindRoleGhostRoleSilicon = Роль призрака (Синтет)
    .desc = { ent-MindRoleGhostRoleNeutral.desc }
ent-MindRoleGhostRoleSiliconAntagonist = Роль призрака (Синтет антагонист)
    .desc = { ent-MindRoleGhostRoleNeutral.desc }
...
ent-MindRoleJob = Роль работа
    .desc = { ent-BaseMindRole.desc }
ent-MindRoleSubvertedSilicon = Роль дефектный синтет
