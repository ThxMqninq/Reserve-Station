...
cmd-replay-skip-help = replay_skip <кол-во тиков или время>
cmd-replay-skip-hint = Кол-во тиков или время (ЧЧ:ММ:СС).
...
cmd-replay-set-time-hint = Тик или время (ЧЧ:ММ:СС), начиная с
cmd-replay-error-time = "{ $time }" не является целым числом или временем.
...
# Time Control UI
replay-time-box-scrubbing-label = Динамическая Чистка
