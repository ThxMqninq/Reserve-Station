...
uplink-binary-implant-desc = Позволяет пользователю подключаться к бинарному каналу синтетов. Однако говорить об этом не рекомендуется, по крайней мере, до тех пор, пока ИИ не выйдет из строя.
